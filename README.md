...
This R package accompanies the following paper and contains a set of R functions to replace the scripts that were in the online appendix of the paper. We received multiple requests over the years to make it available as an R package.
